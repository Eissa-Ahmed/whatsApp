...
import 'package:whats_app/Presentation/HomeChat/View/SingleChat/Widgets/appBar.dart';
...
class SingleChat extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () {
        if (cubit.showEmoji || cubit.selected) {
          cubit.colseEmoji();
      ...
      child: BlocConsumer<HomeCubit, HomeState>(
        ...
        builder: (context, state) {
          return Scaffold(
            appBar: cubit.selected
                ? appBarSelected(cubit, context, userModel)
                : appBarSingleChat(context, userModel),
            body: InkWell(
